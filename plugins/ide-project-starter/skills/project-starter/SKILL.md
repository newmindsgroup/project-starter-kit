...
For an existing starter project asking to update its kit copies, follow the trusted toolkit's docs/PROJECT-UPGRADES.md. Stage and check a candidate before reviewed manual application and finish verification. Preserve identity, memory and local customizations. At the end of a pilot, invoke starter-review to record feedback and consider a sanitized kit proposal.
